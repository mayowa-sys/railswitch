...
const STEPS = [
  {
    ...
    description:
        "At the billing date, RailSwitch initiates a charge against the customer\u2019s tokenized card via Nomba.",
    icon: CreditCard,
  ...
  },
  {
    ...
    title: "Smart retries",
    description:
        "If the card fails, up to 3 retries are scheduled — timing-optimized for payday windows and Nigerian banking liquidity hours.",
    icon: ArrowRight,
  ...
  },
  {
    ...
    description:
        "After retries are exhausted, a one-time virtual account is generated. Amount-locked. Expires when paid or at cycle end.",
    icon: CreditCard,
  ...
  },
  {
    ...
    title: "USSD + WhatsApp",
    description:
        "If the VA window closes, a USSD push fires, followed by a WhatsApp message with all payment options. Customer pays via any channel.",
    icon: MessageCircle,
  ...
  },
  {
    ...
    description:
        "The moment payment lands on any rail, the state machine transitions to active. Webhook fires. Invoice marked paid. Revenue recovered.",
    icon: CheckCircle2,
      ...
      <section id="how-it-works" className="py-24 md:py-32 bg-zinc-50/80 dark:bg-zinc-950/50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="relative">
            {/* Connector line — gradient that matches the icon palette */}
            <div
                className="absolute left-7 top-10 bottom-10 w-px hidden md:block"
                style={{
                  background:
                      "linear-gradient(to bottom, rgb(99 102 241 / 0.5), rgb(168 85 247 / 0.5), rgb(236 72 153 / 0.5), rgb(244 63 94 / 0.5), rgb(16 185 129 / 0.5))",
                }}
            />
                  ...
                  <FadeIn key={step} delay={i * 90}>
                    <div className="relative flex gap-6 md:gap-8">
                      ...
                      <div className="flex-shrink-0 relative z-10">
                        <div className={`h-14 w-14 rounded-2xl bg-gradient-to-br ${color} flex items-center justify-center shadow-lg shadow-zinc-200/60 dark:shadow-zinc-950/60`}>
