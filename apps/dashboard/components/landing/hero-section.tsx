  ...
  return (
      <section className="relative overflow-hidden py-24 md:py-32 lg:py-40">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 text-center">
          {/* Badge */}
          <div
              className="rs-fade-up inline-flex items-center gap-2 rounded-full border border-indigo-200 dark:border-indigo-800/60 bg-indigo-50 dark:bg-indigo-950/50 px-4 py-1.5 mb-8"
          ...
          {/* Headline */}
          <h1
              className="rs-fade-up text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.1] mb-6"
          ...
          {/* Sub */}
          <p
              className="rs-fade-up text-lg md:text-xl text-zinc-500 dark:text-zinc-400 max-w-2xl mx-auto mb-10 leading-relaxed"
              style={{ animationDelay: "160ms" }}
          >
            Card declines in Nigeria run 20–30%. When the card fails, RailSwitch
            cascades through virtual accounts, USSD, and WhatsApp — so your
            customer pays, and you keep the revenue.
          </p>

          {/* CTAs */}
          <div
              className="rs-fade-up flex flex-col sm:flex-row items-center justify-center gap-4"
          ...
          {/* Social proof */}
          <p
              className="rs-fade-up mt-8 text-xs text-zinc-400 dark:text-zinc-500"
              style={{ animationDelay: "320ms" }}
          >
            No credit card required · Powered by{" "}
