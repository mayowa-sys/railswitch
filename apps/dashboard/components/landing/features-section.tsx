...
const FEATURES = [
  ...
  },
  {
    ...
    description:
        "One-time Nomba VAs scoped to the subscription cycle. Amount-locked, reference-bound — no fake-alert risk. Customer transfers; subscription activates.",
    color: "violet",
  },
  {
    icon: Smartphone,
    title: "USSD push",
    description:
        "Nomba-powered USSD prompts on supported banks. Customer dials a code, enters PIN, money moves. No app, no internet.",
    color: "purple",
  },
  {
    icon: MessageCircle,
    ...
    description:
        "Templated messages with all payment options — VA number, USSD code, checkout link. Meets customers where they already are.",
    color: "emerald",
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description:
        "Live preview before any plan change — line items, credits, net charge, next billing date. Upgrades, downgrades, pause credits, cycle switches.",
    color: "rose",
  },
  {
    icon: Webhook,
    ...
    description:
        "HMAC-SHA256 signed deliveries to your endpoints. Retry policy (30s → 24h), replay tool in dashboard, full delivery logs for debugging.",
    color: "sky",
  },
  {
    icon: Code2,
    title: "Two SDKs, day one",
    description:
  ...
  },
  {
    ...
    title: "Audit log",
    description:
        "Every state transition logged immutably: merchant, subscription, from-state, to-state, actor, reason, timestamp. Visible in the dashboard.",
    color: "orange",
  },
];
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <FadeIn className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 leading-relaxed">
              Plans, billing cycles, proration, dunning, customer portal, webhooks, SDKs.
              The cascade is the headline — the rest is what makes it shippable.
            </p>
          </FadeIn>
            ...
            {FEATURES.map(({ icon: Icon, title, description, color }, i) => {
              ...
              return (
                  <FadeIn key={title} delay={i * 60}>
                    <div className="group relative h-full rounded-2xl border border-zinc-200 dark:border-zinc-800/60 bg-white dark:bg-zinc-900/50 p-6 hover:shadow-lg hover:shadow-zinc-200/60 dark:hover:shadow-zinc-950/60 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all duration-300 hover:-translate-y-0.5">
