...
interface LiveSubscription {
  ...
  cascadeHistory: { step: string; status: "success" | "failed" | "pending"; note?: string; attemptedAt?: string }[];
}
interface LivePlan { id: string; name: string; amount: number; }
interface LiveCustomer { id: string; name: string; email: string; }

function CascadeTimeline({ history }: { history: LiveSubscription["cascadeHistory"] }) {
  return (
...
export function SubscriptionDetailDrawerLive({ subscription, plans, customers, onClose }: Props) {
              ...
              <section>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Link
                    ...
                    className="shrink-0 text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 text-xs underline"
                  >
                    View
                  </Link>
                </div>
              ...
              <section>
                ...
                <dl className="space-y-2">
                  {[
                    ...
                    { label: "State", value: subscription.state },
                    {
                      label: "Next billing",
